...
CREATE TABLE "new_Configuracion" (
    ...
    "calComEnabled" BOOLEAN NOT NULL DEFAULT false,
    "calComLink" TEXT,
    "calComApiKey" TEXT,
    "calComWebhookSecret" TEXT,
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL
);
INSERT INTO "new_Configuracion" ("createdAt", "farmaciaCiudad", "farmaciaDireccion", "farmaciaEmail", "farmaciaLogo", "farmaciaNombre", "farmaciaTelefono", "farmaciaWeb", "farmaciaWhatsapp", "googleAccessToken", "googleCalendarEnabled", "googleCalendarId", "googleClientId", "googleClientSecret", "googleRedirectUri", "googleRefreshToken", "googleTokenExpiry", "id", "parametrosReferencia", "updatedAt", "valoracionBioActiva") SELECT "createdAt", "farmaciaCiudad", "farmaciaDireccion", "farmaciaEmail", "farmaciaLogo", "farmaciaNombre", "farmaciaTelefono", "farmaciaWeb", "farmaciaWhatsapp", "googleAccessToken", "googleCalendarEnabled", "googleCalendarId", "googleClientId", "googleClientSecret", "googleRedirectUri", "googleRefreshToken", "googleTokenExpiry", "id", "parametrosReferencia", "updatedAt", "valoracionBioActiva" FROM "Configuracion";
